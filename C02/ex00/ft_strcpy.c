...
/*char *ft_strcpy(char *dest, const char *src) {
    char *ptr = dest; // Guarda o início de dest para retornar ao final
    while (*src != '\0') {
        *dest = *src; // Copia o caractere de src para dest
        dest++; // Avança o ponteiro dest
        src++; // Avança o ponteiro src
    }
    *dest = '\0'; // Adiciona o caractere nulo no final de dest
    return ptr; // Retorna o ponteiro original de dest
}*/
